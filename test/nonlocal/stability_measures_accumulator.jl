...
@testset "dumb map analytic" begin
    ...
    @testset "mapping" begin
        ...
        results_expected = Dict(
            ...
            "finite_time_basin_stability" => Dict(2 => 0.11111, 1 => 0.11111),
            ...
            "characteristic_return_time" => Dict(2 => 0.0, 1 => 0.0),
            "reactivity" => Dict(2 => -1.0, 1 => -1.0),
            "maximal_amplification" => Dict(2 => 1.0, 1 => 1.0),
            "maximal_amplification_time" => Dict(2 => 0.0, 1 => 0.0)
        )
    ...
    @testset "continuation" begin
        ...
        measures_cont_expected = Dict(
            ...
            "characteristic_return_time" => [Dict(1 => 0.0), Dict(2 => 0.0, 1 => 0.0)],
            "reactivity" => [Dict(1 => -1.0), Dict(2 => -1.0, 1 => -1.0)],
            "maximal_amplification" => [Dict(1 => 1.0), Dict(2 => 1.0, 1 => 1.0)],
